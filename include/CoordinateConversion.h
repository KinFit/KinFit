...
//Set variables in conversion object for later use in the setvars/seterrors functions
//Angles are input in radians
...
//Same as above but in array form -- Cart[X, Y, Z, Px, Py, Pz], Spher[mom, theta, phi, R, Z]
...
//Functions for retrieving values from the conversion object
...
//Setting variable and error values in terms of the values inputted via "set" functions;
//All spherical parameters are required for conversion to Cartesian and vice-versa
//Commented out equations are without correlation factors between the variables in the equations
