...
Int_t analysis_user(TString infileList="~/KinFit/input.root", TString outfile = "fitted_test.root", Int_t nEvents=-1){
    ...
    pids.push_back(14); pids.push_back(11);
    ...
    RootAnalyzer.doFitterTask("Vertex", pids);
